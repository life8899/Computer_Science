...
public class HourlyEmployee extends Employee
{
    ...
    /**
     * Tests if Two Students are the Same based on Hourly Employee Attributes
     * 
     * @param o Student Object to be Tested
     * @return Whether or Not Students are the Same based on ALL Hourly Employee Attributes
     */
    public boolean equals(Object o)
    {
        if (super.equals(o))
        {
            ...
            {
                HourlyEmployee heO = (HourlyEmployee) o;
                if (this.hoursWorked == heO.getHoursWorked() && this.hourlyRate == heO.getHourlyRate())
                    return true;
            }
        }
        return false;
